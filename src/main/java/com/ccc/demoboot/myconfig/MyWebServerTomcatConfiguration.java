package com.ccc.demoboot.myconfig;
 ...
 */
@Configuration
public class MyWebServerTomcatConfiguration {

    // 取Application.properties属性文件里面的值
     ...
     * 内部类 默认http连接
     */
    public class MyTomcatConnectionCustomizer implements
