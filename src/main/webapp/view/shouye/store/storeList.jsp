...
<div class="container">
    ...
    <div class="ui inverted menu" style="margin-bottom: 0px">
        ...
        <div class="right menu">
            <a class="item ui " href="/me"><img src="/images/store/sign-up.svg" class="img-circle"
        ...
        <div class="ui menu">
            ...
            <div>
                <a class="ui label image" style="display: inline-block">
                    <img class="ui basic image " src="/images/store/back.svg"> 返回
            ...
            <div class="ui image ">
                <a href="#" class="item ui">
                    <img src="/images/store/export.svg" style="width: 40px;height: 40px">导出
                </a>
            </div>
