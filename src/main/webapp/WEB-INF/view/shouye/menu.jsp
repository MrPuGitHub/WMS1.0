...
<h3 style="text-align: center"><a href="https://www.baidu.com/" target="main" class="btn btn-info" role="button">
...
<h3 style="text-align: center"><a href="#" target="main" class="btn btn-info" role="button"><img src="<%=path%>/img/pandian.jpg"style="height: 35px;">盘点</a></h3>
...
<h3 style="text-align: center"><a href="#" target="main" class="btn btn-info" role="button"><img src="<%=path%>/img/yuangong.jpg"style="height: 35px;">员工绩效统计</a></h3>
</div>
</body>
</html>